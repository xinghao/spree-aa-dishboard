  ...
  module Aa
    ...
    class DashboardController < Spree::Admin::BaseController
      def index
        ...
        @orders = Spree::Order.where("(state = 'complete' and payment_state != 'paid') or ((state != 'complete' or completed_at is null) and payment_state = 'paid')").order("completed_at asc").all 
